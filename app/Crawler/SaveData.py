...
def update_table(table_name, crawl_function, dates,opinion = None):
    ...
    for d in progress:
        ...
        # update single dataframe
            ...
            if opinion == None:
                ...
                to_SQL(data, table_name,index='頁數')
...
def to_SQL(df, table_name,index='date'):
